...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _welcome_nvue_vue_type_template_id_53d4afb2_scoped_true_mpType_page__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./welcome.nvue?vue&type=template&id=53d4afb2&scoped=true&mpType=page */ 263);
...
function injectStyles (context) {
  ...
  if(!this.options.style){
      ...
      if(Vue.prototype.__merge_style){
                Vue.prototype.__merge_style(__webpack_require__(/*! ./welcome.nvue?vue&type=style&index=0&id=53d4afb2&scoped=true&lang=css&mpType=page */ 267).default, this.options.style)
            }else{
                Object.assign(this.options.style,__webpack_require__(/*! ./welcome.nvue?vue&type=style&index=0&id=53d4afb2&scoped=true&lang=css&mpType=page */ 267).default)
            }
...
//
//
var _default = { data: function data() {return {};}, components: { wyyIcon: _wyyIcon.default }, created: function created() {setTimeout(function () {uni.redirectTo({ url: '../index/index' });
    }, 500);
    // this.check_login();
  },
  ...
  methods: {
    check_login: function check_login() {var _this = this;
      _repeater.default.user.check_login(function (user_status) {
        __f__("log", user_status, " at pages\\welcome\\welcome.nvue:41");
