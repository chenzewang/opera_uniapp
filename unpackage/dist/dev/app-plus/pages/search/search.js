...
/* harmony import */ var _pages_search_search_nvue_mpType_page__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./pages/search/search.nvue?mpType=page */ 156);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _search_nvue_vue_type_template_id_2a161e10_mpType_page__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./search.nvue?vue&type=template&id=2a161e10&mpType=page */ 157);
/* harmony import */ var _search_nvue_vue_type_script_lang_js_mpType_page__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./search.nvue?vue&type=script&lang=js&mpType=page */ 159);
...
function injectStyles (context) {
  ...
  if(!this.options.style){
      ...
      if(Vue.prototype.__merge_style){
                Vue.prototype.__merge_style(__webpack_require__(/*! ./search.nvue?vue&type=style&index=0&lang=css&mpType=page */ 168).default, this.options.style)
            }else{
                Object.assign(this.options.style,__webpack_require__(/*! ./search.nvue?vue&type=style&index=0&lang=css&mpType=page */ 168).default)
            }
...
var _playlist_card = _interopRequireDefault(__webpack_require__(/*! ../../components/playlist_card.nvue */ 161));
var _repeater = _interopRequireDefault(__webpack_require__(/*! @/utils/repeater.js */ 25));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} //
//
//
//
...
var _default = { components: { uniTransition: _uniTransition.default, wyyPlay: _wyy_play.default, songCard: _song_card.default, playlistCard: _playlist_card.default, wyyIcon: _wyyIcon.default }, data: function data() {return { hot_list: [], show_result: false, result_bars: [{ id: 1018, name: '综合', key: 'comprehensive' }, { id: 1, name: '单曲', key: 'song' }, // {id: 1014, name: '视频', key: 'mv'},
      ...
      { id: 1000, name: '歌单', key: 'playlist' }], current_keyword: '', current_search_result: {}, current_page: 0, current_bar_index: 0, current_scroll_into: '', mode_class: ['fade'], transfrom_class: { 'position': 'fixed', 'bottom': '90rpx', 'top': 0, 'left': 0, 'right': 0, 'justify-content': 'center', 'align-items': 'center' } };}, watch: { current_bar_index: function current_bar_index(index, old_index) {if (!this.show_result) {return;}if (!this.current_search_result[this.result_bars[index].key]) {this.search();}} }, computed: { played: function played() {return this.$store.state.played;}, playlist_data: function playlist_data() {if (!this.search_result_init_check('playlist')) {return;}var playlists = this.current_search_result.playlist.playlists;var new_playlists = [];playlists.forEach(function (playlist) {var tmp_playlist = {};tmp_playlist.id = playlist.id;tmp_playlist.coverImgUrl = playlist.coverImgUrl;tmp_playlist.name = playlist.name;tmp_playlist.trackCount = playlist.trackCount;tmp_playlist.creator = playlist.creator;new_playlists.push(tmp_playlist);});return new_playlists;}, comprehensive_data: function comprehensive_data() {if (!this.search_result_init_check('comprehensive')) {return;}var comprehensive = this.current_search_result.comprehensive;if (comprehensive.song.songs) {//format songs信息
        comprehensive.song.songs.forEach(function (song) {song.id = song.id;song.name = song.name;song.artists = song.ar;song.album_name = song.al.name;});}return comprehensive;}, songs_data: function songs_data() {if (!this.search_result_init_check('song')) {return;}if (this.current_search_result.song.songCount == 0) {return;}var songs = this.current_search_result.song.songs;var format_songs = [];songs.forEach(function (song) {var format_song = {};format_song.id = song.id;format_song.name = song.name;format_song.artists = song.artists;format_song.album_name = song.album.name;
        format_songs.push(format_song);
      });
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _playlist_card_nvue_vue_type_template_id_32f1411c___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./playlist_card.nvue?vue&type=template&id=32f1411c& */ 162);
/* harmony import */ var _playlist_card_nvue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./playlist_card.nvue?vue&type=script&lang=js& */ 164);
...
function injectStyles (context) {
  ...
  if(!this.options.style){
      ...
      if(Vue.prototype.__merge_style){
                Vue.prototype.__merge_style(__webpack_require__(/*! ./playlist_card.nvue?vue&type=style&index=0&lang=css& */ 166).default, this.options.style)
            }else{
                Object.assign(this.options.style,__webpack_require__(/*! ./playlist_card.nvue?vue&type=style&index=0&lang=css& */ 166).default)
            }
