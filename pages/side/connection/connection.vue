<template>
	<view>
		...
		<div><web-view src="/hybrid/html/getlocalip.html" @message="handleMessage" :webview-styles="webviewStyles"></web-view></div>
		<div class="fav_list">
			<div data-v-357a65ed="" class="fav_list_box">
				<div class="fav_list_title" @tap="connectPlayer"><h3 class="fav_list_title_h3">目前连接的IP</h3></div>
		...
		<div class="fav_list">
			<div data-v-357a65ed="" class="fav_list_box">
				...
				<div class="my_fav_list">
					...
					<button class="iplist cell" plain v-for="(item, index) in ipList" :key="index" :data-ip="item" @tap="connectPlayer">
						<span>{{ item }}</span>
					</button>
				</div>
			</div>
...
import { connectPlayer } from '@/model/player.js';
var wv; //计划创建的webview
