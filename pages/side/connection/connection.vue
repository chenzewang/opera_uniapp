	...
	<view>
		...
		<div class="fav_list">
			<div data-v-357a65ed="" class="fav_list_box">
				<div class="fav_list_title"><h3 class="fav_list_title_h3">已连接ip</h3></div>
				<div class="my_fav_con" >
					<ul class="my_fav_list"style="border-bottom: 1px solid #e0e0e0;">
						<li class="iplist">已连接ip</li>
					</ul>
				</div>
				<div class="fav_list_title"><h3 class="fav_list_title_h3">可连接ip</h3></div>
				<div class="my_fav_con">
					<ul class="my_fav_list">
						<li class="iplist">可连接ip</li>
		...
		<button style="margin-top: 75%; width: 75%;">重新扫描</button>
	</view>
</template>
